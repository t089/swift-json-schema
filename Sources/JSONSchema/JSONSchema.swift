...
public struct JSONSchema: Codable, Equatable, Sendable {
    ...
    public var `type`: String? {
        ...
        case .true, .false, .anyOf, .allOf, .oneOf, .not:
            return nil  // These do not have a type property in the schema
        }
    }
    ...
    public var description: String? {
        ...
        case .true, .false, .anyOf, .allOf, .oneOf, .not:
            return nil  // These do not have a description property in the schema
        }
    }

    /// Access the schema as a StringSchema if it represents a string type.
    public var string: StringSchema? {
        if case .string(let schema) = _type {
            return schema
        }
        return nil
    }
    ...
    public var object: ObjectSchema? {
        if case .object(let schema) = _type {
            return schema
        }
        return nil
    }
    ...
    public var array: ArraySchema? {
        if case .array(let schema) = _type {
            return schema
        }
        return nil
    }
    ...
    public var integer: IntegerSchema? {
        if case .integer(let schema) = _type {
            return schema
        }
        return nil
    }
    ...
    public var number: NumberSchema? {
        if case .number(let schema) = _type {
            return schema
        }
        return nil
    }
    ...
    public var anyOf: [JSONSchema]? {
        if case .anyOf(let schema) = _type {
            return schema.anyOf
        }
        return nil
    }
    ...
    public var allOf: [JSONSchema]? {
        if case .allOf(let schema) = _type {
            return schema.allOf
        }
        return nil
    }
    ...
    public var oneOf: [JSONSchema]? {
        if case .oneOf(let schema) = _type {
            return schema.oneOf
        }
        return nil
    }
    ...
    public init(from decoder: any Decoder) throws {
        ...
        throw DecodingError.dataCorruptedError(
            in: container,
            debugDescription:
                "Unsupported JSON Schema type. Errors: \(errors.map { "\($0)" }.joined(separator: ", "))"
        )
    }
    ...
    public func encode(to encoder: any Encoder) throws {
        ...
        case .anyOf(let schema):
            try schema.encode(to: encoder)
        case .allOf(let schema):
            try schema.encode(to: encoder)
    ...
    public static func `enum`(description: String? = nil, values: [String]) -> Self {
    ...
    public static func array(
        description: String? = nil, items: JSONSchema, minItems: Int? = nil, maxItems: Int? = nil,
        ...
        JSONSchema(
            type: .array(
                .init(
                    description: description,
                    items: items, minItems: minItems, maxItems: maxItems, uniqueItems: uniqueItems))
        )
    }
    ...
    public static func integer(description: String? = nil, minimum: Int? = nil, maximum: Int? = nil)
        -> Self
    {
        JSONSchema(
            type: .integer(.init(description: description, minimum: minimum, maximum: maximum)))
    }
    ...
    public static func number(
        ...
        JSONSchema(
            type: .number(.init(description: description, minimum: minimum, maximum: maximum)))
    }
    ...
    public static func anyOf(_ schemas: [JSONSchema]) -> Self {
        JSONSchema(type: .anyOf(.init(anyOf: schemas)))
    }
    ...
    public static func allOf(_ schemas: [JSONSchema]) -> Self {
        JSONSchema(type: .allOf(.init(allOf: schemas)))
    }
    ...
    public static func oneOf(_ schemas: [JSONSchema]) -> Self {
        JSONSchema(type: .oneOf(.init(oneOf: schemas)))
    }
